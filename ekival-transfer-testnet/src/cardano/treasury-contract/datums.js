...
export const serializeBountyDatum = ({ providerAddress, funderAddress, lovelaceAmount, minValue, expirationTime, serviceType, commitStatus }) => {
...
export const serializeTreasuryDatum = ({ providerAddress, funderAddress, lovelaceAmount, minValue, expirationTime, serviceType, commitStatus }) => {
  const fields = Cardano.Instance.PlutusList.new();
  fields.add(Cardano.Instance.PlutusData.new_bytes(providerAddress));
  fields.add(Cardano.Instance.PlutusData.new_bytes(funderAddress));
  fields.add(
