...
export const treasuryIssuerAddress = "addr_test1qzwx3dj9tk48j82khgd9cvlme83seysyr9r6wn4cykyuhea7q3uj3jrwuy3th9de36ncayrph3gwjg4d62q8k42adgxs799sdx"
export const ekivalAddress = "addr_test1qzwx3dj9tk48j82khgd9cvlme83seysyr9r6wn4cykyuhea7q3uj3jrwuy3th9de36ncayrph3gwjg4d62q8k42adgxs799sdx"
export const transferProviderAddress = "addr_test1qzwx3dj9tk48j82khgd9cvlme83seysyr9r6wn4cykyuhea7q3uj3jrwuy3th9de36ncayrph3gwjg4d62q8k42adgxs799sdx"
export const treasuryContractAddress = "addr_test1wzrdejd58gvgjrn9j9c6899djlrmg0n3x3cqmutxgt5xgychj4jtl"
//"addr_test1wrqwnv5e9warvfv2e5emygj277zqecmlyyuuqnvuak8m9mc3t93px"
export const bountyContractAddress = "addr_test1wzwtgddftrnjxuvcz5mm27ch3ymdd4qmr77ce5gefa4gq9q9xuqsw"

export const commitToBounty = async (bDatum, tDatum, { contributorAddress, utxosParam, bountySlug, bAda, bGimbals, tUtxo, tLovelaceIn, tGimbalsIn }) => {
  try {
    ...
    outputs.add(
      createTxOutput(
        ...
        assetsToValue([
          ...
          { unit: "cb4a5cb63378a521cb82bdfacc4a8fd543b22ae19c094b75e13f78537447696d62616c", quantity: `${bGimbals}` },
          { unit: "5d6b6c332866044b2a8bdd147d92f77e42714986f1cb98cef70e201f67656e7479", quantity: "1" }
        ]),
        { datum: bountyDatum }
      )
    );
    ...
    outputs.add(
      createTxOutput(
        ...
        assetsToValue([
          ...
          { unit: "cb4a5cb63378a521cb82bdfacc4a8fd543b22ae19c094b75e13f78537447696d62616c", quantity: `${gimbalsToTreasury}` }
        ]),
        { datum: treasuryDatum }
      )
    );
